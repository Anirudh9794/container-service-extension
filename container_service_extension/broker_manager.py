...
def get_cluster_info(request_data, tenant_auth_token, is_jwt_token,
    ...
    if ovdc_name is not None and org_name is not None:
        ...
        return broker.get_cluster_info(request_data, telemetry=telemetry), broker # noqa: E501
...
def get_cluster_and_broker(request_data, tenant_auth_token, is_jwt_token,
    ...
    try:
        return vcd_broker.get_cluster_info(request_data, telemetry=telemetry), vcd_broker # noqa: E501
    ...
    for pks_ctx in pks_ctx_list:
        ...
        try:
            return pks_broker.get_cluster_info(request_data, telemetry=telemetry), pks_broker # noqa: E501
